...
//新增罩杯尺寸 首頁
Route.get('/AudreySP/addSizeindex','AddsizeController.index')
//刪除罩杯尺寸
Route.get('/AudreySP/delSize/:id','AddsizeController.delete')
//新增尺寸
Route.get('/AudreySP/addSize','AddsizeController.add')
Route.post('/AudreySP/addSize','AddsizeController.create')
...
//取得尺寸
Route.get('/AudreySP/getSize','GuestinfoController.getsize')